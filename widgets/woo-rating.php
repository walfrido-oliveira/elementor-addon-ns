<?php
class Elementor_Woo_rating_Widget extends \Elementor\Widget_Base
{

  public function get_name()
  {
    return 'woo-rating_widget';
  }

  public function get_title()
  {
    return esc_html__('Adicona formulário de avaliação do Woocomerce', 'elementor-addon');
  }
        ...
        <?php if (get_option('woocommerce_review_rating_verification_required') === 'no' || wc_customer_bought_product('', get_current_user_id(), $product->get_id())) : ?>
          <div id="review_form_wrapper">
            <div id="review_form">
              ...
              $comment_form = array(
                'title_reply'         => $count ? esc_html__('Add a review', 'woocommerce') : sprintf(esc_html__('Be the first to review &ldquo;%s&rdquo;', 'woocommerce'), get_the_title()),
